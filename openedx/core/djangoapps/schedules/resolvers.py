...
class CourseNextSectionUpdate(PrefixedDebugLoggerMixin, RecipientResolver):
    ...
    def get_schedules(self):
        ...
        schedules = Schedule.objects.select_related('enrollment').filter(
            ...
            start_date__gte=self.target_datetime - course_duration,
            start_date__lt=self.target_datetime,
        )
        ...
        for schedule in schedules:
            ...
            try:
                week_highlights, week_num = get_next_section_highlights(course.id, start_date, target_date)
